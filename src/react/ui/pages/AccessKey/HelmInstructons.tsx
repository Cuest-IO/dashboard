...
const HelmInstructions = ({ credentials }: Props) => {
  ...
  return (
    <Grid container direction="column">
      ...
      <Grid item xs={12}>
        <Typography>
          Please note, below instruction is personalized for your account and contains security keys. Please keep
          privately
        </Typography>
      </Grid>
        ...
        <Grid container alignItems="center">
          <Grid item xs={11}>
            <Box borderRadius="4px" py={2} px={6} bgcolor="rgb(248,248,248)">
              <Typography color="rgb(51,51,51)">{helmAddCommand}</Typography>
            </Box>
          </Grid>
          <Grid item xs={1}>
            <Tooltip title="Copy">
      ...
      <Grid item xs={12} pt={4}>
        <Typography>Update local repo</Typography>
      </Grid>
      <Grid item xs={12} pt={4}>
        <Grid container alignItems="center">
          <Grid item xs={11}>
            <Box borderRadius="4px" py={2} px={6} bgcolor="rgb(248,248,248)">
              <Typography color="rgb(51,51,51)">{helmUpdateCommand}</Typography>
            </Box>
          </Grid>
          <Grid item xs={1}>
            <Tooltip title="Copy">
      ...
      <Grid item xs={12}>
        <Typography>
          If you intend to run multiple clusters or wish to have more personalized cluster name, please replace the
          cluster id with a unique and meaningful name
        </Typography>
      </Grid>
      <Grid item xs={12} pt={4}>
        <Grid container alignItems="center">
          <Grid item xs={11}>
            <Box borderRadius="4px" py={2} px={6} bgcolor="rgb(248,248,248)">
              <Typography color="rgb(51,51,51)">{helmInstallCommand}</Typography>
            </Box>
          </Grid>
          <Grid item xs={1}>
            <Tooltip title="Copy">
